...
disks = [ {name="cluster-node1", sid="BP9", usr_mount="/usr/sap/BP9", usr_size="1", usr_type="pd-standard", usr_vg="vgsharedsap", usr_lv="BP9_usr_sap_node1", data_mount="/hana/data/BP9", data_size="1", data_type="pd-standard", data_vg="vgdata", data_lv="BP9_data_mnt00001", log_mount="/hana/log/BP9", log_size="1", log_type="pd-standard", log_vg="vglog", log_lv="BP9_log_mnt00001", shared_mount="/hana/shared/BP9", shared_size="1", shared_type="pd-standard", shared_vg="vgshared", shared_lv="BP9_shared", databkp_mount="/hana_backup/BP9/data", databkp_size="1", databkp_type="pd-standard", databkp_vg="vgbkpdata", databkp_lv="BP9_data_backup", logbkp_mount="/hana_backup/BP9/log", logbkp_size="1", logbkp_type="pd-standard", logbkp_vg="vgbkplog", logbkp_lv="BP9_log_backup"}, {name="cluster-node2", sid="BP9", usr_mount="/usr/sap/BP9", usr_size="2", usr_type="pd-standard", usr_vg="vgsharedsap", usr_lv="BP9_usr_sap_node2", data_mount="/hana/data/BP9", data_size="1", data_type="pd-standard", data_vg="vgdata", data_lv="BP9_data_mnt00002", log_mount="/hana/log/BP9", log_size="1", log_type="pd-standard", log_vg="vglog", log_lv="BP9_log_mnt00002", shared_mount="/hana/shared/BP9", shared_size="1", shared_type="pd-standard", shared_vg="vgshared", shared_lv="BP9_shared", databkp_mount="/hana_backup/BP9/data", databkp_size="1", databkp_type="pd-standard", databkp_vg="vgbkpdata", databkp_lv="BP9_data_backup", logbkp_mount="/hana_backup/BP9/log", logbkp_size="1", logbkp_type="pd-standard", logbkp_vg="vgbkplog", logbkp_lv="BP9_log_backup"} ]
